...
@Component({
  selector: 'gh-linechart2',
  templateUrl: './linechart2.component.html',
  styleUrls: ['./linechart2.component.scss']
})
export class Linechart2Component implements OnInit,AfterViewInit {

  constructor() { }
  @ViewChild('myLineChart2')
  chartElementRef2 !: ElementRef<HTMLCanvasElement>;
  @Input()
  gradient!:string[]
  ...
  ngAfterViewInit(): void {
    ...
    //const ctx=this.chartElementRef.nativeElement.getContext('2d')
    const canvas=<HTMLCanvasElement>document.getElementById('myLineChart2');
    ...
    this.renderLine(9,6,5,2,6,4,9,ctx,gradient)
  ...
  renderLine(day1: number, day2: number, day3: number, day4: number, day5: number, day6: number, day7: number, ctx: any, gradient: CanvasGradient | undefined){
    ...
    var myLChart = new Chart("myLineChart2", {
