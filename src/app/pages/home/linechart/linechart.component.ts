...
/*  @ViewChild('myLineChart')
  ...
  ngAfterViewInit(): void {
    ...
    const canvas=<HTMLCanvasElement>document.getElementById('myLineChart');
    ...
    this.renderLine(1,6,5,8,6,10,9,ctx,gradient)
  ...
  renderLine(day1: number, day2: number, day3: number, day4: number, day5: number, day6: number, day7: number, ctx: any, gradient: CanvasGradient | undefined){
    ...
    var myLChart = new Chart("myLineChart", {
